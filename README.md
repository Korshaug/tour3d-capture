...
**https://korshaug.github.io/tour3d-capture/** -- the capture page
**https://korshaug.github.io/tour3d-capture/shot-list.html** -- the one-page shot list, for the camera app
...
The shot list is `docs/shot-list.html` in the tour3d repository, copied as is. The capture page is
one self-contained file, built from the tour3d repository
